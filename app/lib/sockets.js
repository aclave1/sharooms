...
var Sockets = (function () {
    ...
    Sockets.prototype.resize = function (params) {
        var _this = this;
        return new Promise(function (res, rej) {
            _this.messageScreen(params.screenId, eventstrings.screen.resize, { direction: params.direction });
            res();
        });
    };
    Sockets.prototype.caption = function (params) {
        var _this = this;
        return new Promise(function (res, rej) {
            _this.messageScreen(params.screenId, eventstrings.screen.caption, { text: params.text, userName: params.userName });
            res();
        });
    };
...
var FileParams = (function (_super) {
    __extends(FileParams, _super);
    function FileParams() {
